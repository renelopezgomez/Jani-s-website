...
export type AkarIconstwitterFillIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function AkarIconstwitterFillIcon(props: AkarIconstwitterFillIconProps) {
...
export default AkarIconstwitterFillIcon;
/* prettier-ignore-end */
