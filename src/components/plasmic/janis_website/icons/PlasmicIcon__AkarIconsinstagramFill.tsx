...
export type AkarIconsinstagramFillIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function AkarIconsinstagramFillIcon(
  props: AkarIconsinstagramFillIconProps
) {
...
export default AkarIconsinstagramFillIcon;
/* prettier-ignore-end */
