...
import sty from "./PlasmicButton.module.css"; // plasmic-import: hAMh4UsW8K-n/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: q5hvSKOku0i7/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: qrZ5muO3VcBU/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cZk7K)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__fazmD)}
                role={"img"}
              />
            ),
